...
import Records from '../Screen8.json';
...
const submit = () =>{
    ...
    let valueOfScreen8 = selectedRecords.join(',')
    alert ("selected records:" +valueOfScreen8);
    navigate("/Screen9", {state:{ valueOfScreen8,valueOfScreen7,valueOfScreen6,valueOfScreen5,valueOfScreen4,valueOfScreen3,valueOfScreen2 }})
        ...
        {/* </div>
             ...
             <div class="page-header">
                            <div class="page-title">
                                <h1 class="hire" style={{paddingTop:'40px',fontWeight:'bolder'}} >How do you prefer the PM contractor or team to work?</h1>
                            </div>
                        </div>
