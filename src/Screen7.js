...
import Records from '../scree7.json';
...
const submit = () =>{
    ...
    let valueOfScreen7 = selectedRecords.join(',')
    alert ("selected records:" +valueOfScreen7);
    navigate("/Screen8", {state:{ valueOfScreen7,valueOfScreen6,valueOfScreen5,valueOfScreen4,valueOfScreen3,valueOfScreen2 }})
        ...
        {/* </div>
             ...
             <div class="page-header">
                            <div class="page-title">
                                <h1 class="hire" style={{paddingTop:'40px',fontWeight:'bolder'}} >When do you want the contractor or PM team to start?</h1>
                            </div>
                        </div>
